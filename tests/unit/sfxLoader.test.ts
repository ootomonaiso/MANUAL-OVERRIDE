...
const EXPECTED_IDS = [
  ...
  'battle_cast_special', 'battle_hit_special', 'battle_cast_none', 'battle_hit_none',
  'battle_fire', 'battle_curse', 'battle_bolt',
...
describe('SfxLoader', () => {
  ...
  it('全78種のSFX id が SFX_DEFS に存在する', () => {
    expect(EXPECTED_IDS.length).toBe(78)
