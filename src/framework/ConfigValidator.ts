...
const RANGE_CHECKS: Array<{
  ...
  { section: 'physics',    field: 'groundAccel',      min: 0, exclusiveMin: true },
  { section: 'physics',    field: 'groundDecel',      min: 0, exclusiveMin: true },
  { section: 'physics',    field: 'airAccel',         min: 0, exclusiveMin: true },
  { section: 'physics',    field: 'airDecel',         min: 0, exclusiveMin: true },
